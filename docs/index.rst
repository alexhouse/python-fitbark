.. Python-FitBark documentation master file, created by
...
If you are only retrieving data that doesn't require authorization, then you can use the unauthorized interface::
    ...
    import fitbark
    unauth_client = fitbark.FitBark('<consumer_key>', '<consumer_secret>')
...
.. autoclass:: fitbark.FitBark
    ...
    .. method:: body(date=None, user_id=None, data=None)
       ...
       Get body data: https://dev.fitbark.com/docs/body/

    .. method:: activities(date=None, user_id=None, data=None)

       Get body data: https://dev.fitbark.com/docs/activity/

    .. method:: foods_log(date=None, user_id=None, data=None)

       Get food logs data: https://dev.fitbark.com/docs/food-logging/#get-food-logs

    .. method:: foods_log_water(date=None, user_id=None, data=None)

       Get water logs data: https://dev.fitbark.com/docs/food-logging/#get-water-logs

    .. method:: sleep(date=None, user_id=None, data=None)

       Get sleep data: https://dev.fitbark.com/docs/sleep/

    .. method:: heart(date=None, user_id=None, data=None)

       Get heart rate data: https://dev.fitbark.com/docs/heart-rate/

    .. method:: bp(date=None, user_id=None, data=None)

       Get blood pressure data: https://dev.fitbark.com/docs/heart-rate/
    ...
    .. method:: recent_foods(user_id=None, qualifier='')
       ...
       Get recently logged foods: https://dev.fitbark.com/docs/food-logging/#get-recent-foods

    .. method:: frequent_foods(user_id=None, qualifier='')

       Get frequently logged foods: https://dev.fitbark.com/docs/food-logging/#get-frequent-foods

    .. method:: favorite_foods(user_id=None, qualifier='')

       Get favorited foods: https://dev.fitbark.com/docs/food-logging/#get-favorite-foods

    .. method:: recent_activities(user_id=None, qualifier='')

       Get recently logged activities: https://dev.fitbark.com/docs/activity/#get-recent-activity-types

    .. method:: frequent_activities(user_id=None, qualifier='')

       Get frequently logged activities: https://dev.fitbark.com/docs/activity/#get-frequent-activities

    .. method:: favorite_activities(user_id=None, qualifier='')

       Get favorited foods: https://dev.fitbark.com/docs/activity/#get-favorite-activities
