...
from fitbark.exceptions import DeleteError, Timeout

URLBASE = "%s/%s/user" % (FitBark.API_ENDPOINT, FitBark.API_VERSION)
...
class CollectionResourceTest(TestBase):
    ...
    def test_body(self):
        ...
        # We need to mock _COLLECTION_RESOURCE before we create the FitBark object,
        # since the __init__ is going to set up references to it
        with mock.patch('fitbark.api.FitBark._COLLECTION_RESOURCE') as coll_resource:
...
class DeleteCollectionResourceTest(TestBase):
    ...
    def test_delete_foods_log(self):
        log_id = "fake_log_id"
        # We need to mock _DELETE_COLLECTION_RESOURCE before we create the FitBark object,
        # since the __init__ is going to set up references to it
        with mock.patch('fitbark.api.FitBark._DELETE_COLLECTION_RESOURCE') as delete_resource:
...
class ResourceAccessTest(TestBase):
    ...
    def test_user_profile_get(self):
        ...
        https://dev.fitbark.com/docs/user/

        Tests the following HTTP method/URLs:
        GET https://api.fitbark.com/1/user/FOO/profile.json
        GET https://api.fitbark.com/1/user/-/profile.json
        """
        user_id = "FOO"
    ...
    def test_user_profile_update(self):
        ...
        https://dev.fitbark.com/docs/user/#update-profile

        Tests the following HTTP method/URLs:
        POST https://api.fitbark.com/1/user/-/profile.json
        """
        data = "BAR"
        url = URLBASE + "/-/profile.json"
    ...
    def test_recent_activities(self):
        ...
        with mock.patch('fitbark.api.FitBark.activity_stats') as act_stats:
            fb = FitBark('x', 'y')
    ...
    def test_foods(self):
        ...
        url = "%s/%s/foods/search.json?query=FOOBAR" % (FitBark.API_ENDPOINT, FitBark.API_VERSION)
        self.common_api_test('search_foods', ("FOOBAR",), {}, (url,), {})
        url = "%s/%s/foods/FOOBAR.json" % (FitBark.API_ENDPOINT, FitBark.API_VERSION)
        self.common_api_test('food_detail', ("FOOBAR",), {}, (url,), {})
        url = "%s/%s/foods/units.json" % (FitBark.API_ENDPOINT, FitBark.API_VERSION)
    ...
    def test_activities(self):
        ...
        GET https://api.fitbark.com/1/activities.json
        POST https://api.fitbark.com/1/user/-/activities.json
        GET https://api.fitbark.com/1/activities/FOOBAR.json
        POST https://api.fitbark.com/1/user/-/activities/favorite/activity_id.json
        DELETE https://api.fitbark.com/1/user/-/activities/favorite/activity_id.json
        """
        url = "%s/%s/activities.json" % (FitBark.API_ENDPOINT, FitBark.API_VERSION)
        self.common_api_test('activities_list', (), {}, (url,), {})
        url = "%s/%s/user/-/activities.json" % (FitBark.API_ENDPOINT, FitBark.API_VERSION)
        self.common_api_test('log_activity', (), {'data' : 'FOO'}, (url,), {'data' : 'FOO'} )
        url = "%s/%s/activities/FOOBAR.json" % (FitBark.API_ENDPOINT, FitBark.API_VERSION)
    ...
    def test_bodyweight(self):
        ...
        GET https://api.fitbark.com/1/user/-/body/log/weight/date/1992-05-12.json
        GET https://api.fitbark.com/1/user/BAR/body/log/weight/date/1992-05-12/1998-12-31.json
        GET https://api.fitbark.com/1/user/BAR/body/log/weight/date/1992-05-12/1d.json
        GET https://api.fitbark.com/1/user/-/body/log/weight/date/2015-02-26.json
        """
        user_id = 'BAR'
    ...
    def test_bodyfat(self):
        ...
        Tests the following methods/URLs:
        GET https://api.fitbark.com/1/user/-/body/log/fat/date/1992-05-12.json
        GET https://api.fitbark.com/1/user/BAR/body/log/fat/date/1992-05-12/1998-12-31.json
        GET https://api.fitbark.com/1/user/BAR/body/log/fat/date/1992-05-12/1d.json
        GET https://api.fitbark.com/1/user/-/body/log/fat/date/2015-02-26.json
        """
        user_id = 'BAR'
...
class SubscriptionsTest(TestBase):
    """
    Class for testing the FitBark Subscriptions API:
    ...
    def test_subscriptions(self):
        ...
        GET https://api.fitbark.com/1/user/-/apiSubscriptions.json
        GET https://api.fitbark.com/1/user/-/FOO/apiSubscriptions.json
        POST https://api.fitbark.com/1/user/-/apiSubscriptions/SUBSCRIPTION_ID.json
        POST https://api.fitbark.com/1/user/-/apiSubscriptions/SUBSCRIPTION_ID.json
        POST https://api.fitbark.com/1/user/-/COLLECTION/apiSubscriptions/SUBSCRIPTION_ID-COLLECTION.json
        """
        ...
        self.common_api_test('subscription', ("SUBSCRIPTION_ID", "SUBSCRIBER_ID"), {},
                (url,), {'method': 'POST', 'headers': {'X-FitBark-Subscriber-id': "SUBSCRIBER_ID"}})
        self.common_api_test('subscription', ("SUBSCRIPTION_ID", "SUBSCRIBER_ID"), {'method': 'THROW'},
            (url,), {'method': 'THROW', 'headers': {'X-FitBark-Subscriber-id': "SUBSCRIBER_ID"}})
...
class PartnerAPITest(TestBase):
    """
    Class for testing the FitBark Partner API:
    https://dev.fitbark.com/docs/
    """
    ...
    def test_intraday_timeseries(self):
        ...
        Tests the following methods/URLs:
        GET https://api.fitbark.com/1/user/-/FOO/date/1918-05-11/1d/1min.json
        GET https://api.fitbark.com/1/user/-/FOO/date/1918-05-11/1d/1min.json
        GET https://api.fitbark.com/1/user/-/FOO/date/1918-05-11/1d/1min/time/03:56/15:07.json
        GET https://api.fitbark.com/1/user/-/FOO/date/1918-05-11/1d/1min/time/3:56/15:07.json
        """
        resource = 'FOO'
